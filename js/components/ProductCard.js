export default function createProductCard(product) {
  ...
  itemListEl.classList.add("catalog__item");
  ...
  const tooltipBtn = itemListEl.querySelector(".tooltip__btn");
  const tooltipContent = itemListEl.querySelector(".tooltip__content");
